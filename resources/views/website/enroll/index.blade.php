                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('training.new-enroll', ['id' => $id])}}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" @if(Session::get('student_id')) value="{{$student->email}}" readonly @endif class="form-control" id="email" name="email"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <label><input type="radio" name="payment_type" value="2"/>Obline</label>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="" class="col-md-3"></label>
                                    <div class="col-md-9">
                                        <input type="submit" class="btn btn-outline-success btn-sm w-100" id="enrollNowBtn" value="Enroll Now"/>
                                    </div>
                                </div>
                            </form>
                        </div>
