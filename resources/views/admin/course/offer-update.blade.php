                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.update-course-offer', ['id' => $course->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" value="{{$course->fee}}" readonly id="horizontal-password-input3" />
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input3" class="col-sm-3 col-form-label">Offer Fee</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="horizontal-password-input3" name="offer_fee"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input35" class="col-sm-3 col-form-label">Offer Date</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="horizontal-password-input35" name="offer_date"/>
                            </div>
                        </div>
